...
begin
  ...
  -- Only perform aggregation if any expenses remain
  if exists (
    ...
    insert into daily_expenses (user_id, "date", category_sums, all_expenses)
    select user_id, "date", category_sums, all_expenses
    from final
    on conflict (user_id, "date") do update
      set category_sums = excluded.category_sums,
